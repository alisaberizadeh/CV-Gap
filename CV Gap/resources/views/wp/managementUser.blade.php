                    ...
                    <form action="{{ route('user.management') }}" method="GET">
                        <div class="input-group mb-3">
                            ...
                            <div class="input-group-append">
                                <button class="btn btn-sm btn-primary" type="submit"><i class="material-icons">search</i></button>
                            </div>
                        </div>
                    </form>
                                                ...
                                                <td>
                                                    @if (auth()->user()->id != $item->id)
                                                        @if (auth()->user()->is_admin == 2)
                                                            <a href="{{ route('user.edit', $item->id) }}" class="btn btn-sm btn-success"><i
                                                        ...
                                                        @else
                                                            @if ($item->is_admin != 2 && $item->is_admin != 1)
                                                                <a href="{{ route('user.edit', $item->id) }}"
                                                                    class="btn btn-sm btn-success"><i class="material-icons">edit</i></a>
                                                                <a href="{{ route('user.delete', $item->id) }}"
                                                                    class="btn btn-sm btn-danger show_confirm"><i
                                                                        class="material-icons">delete</i></a>
                                                                <a href="" class="btn btn-sm btn-dark float-left"><i
